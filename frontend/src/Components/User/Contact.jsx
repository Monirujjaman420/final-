            ...
            <div className="row">
                ...
                <div className="col-md-4 col-lg-4 col-sm-12 ">
                    <div className="card my-5">
                        ...
                        <div className="card-body" style={{ marginTop : "20%", marginBottom: "50%" }}>
                           <p> <span><strong>Call: 01780 88 65 77</strong></span></p> 
                           <p> <span><strong>E-mail: monir-35-367@diu.edu.bd</strong></span></p>
                            <span><strong>Location: Daffodil Internation University, Ashulia, Saver</strong></span> <br />
                        </div>
                    </div>
                </div>
            </div>
